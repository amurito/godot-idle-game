...
Esta versión transforma el juego en un espacio de exploración matemática y económica.
Las mecánicas dejan de ser opacas: el jugador puede leer, entender y razonar el sistema.

Propósito central:

Transparencia > sorpresa.
Comprensión > progresión ciega.

No es una UI linda todavía. Es un osciloscopio.

Esta versión no trata de “ser divertida”, sino de:

exponer dinámicas de crecimiento

hacer visible la relación entre variables

inducir pensamiento sistémico

revelar dominancia de términos

darle identidad a cada productor

Es un instrumento de medición del sistema.

Y cumplió eso al 100%.

stats_label.text =
# IDLE — The Lab (v0.5.1)

**The Lab** es una versión experimental del proyecto IDLE cuyo objetivo no es
aumentar el rendimiento del jugador, sino **hacer visible la estructura matemática
del sistema económico interno**.
...
The Lab funciona como un **laboratorio de incentivos**:
no busca balancear la experiencia de juego, sino
permitir observar y estudiar el comportamiento del modelo.

---

## 🎯 Objetivo de la versión

> Separar economía, análisis y UI — y convertir el juego
> en un entorno de experimentación matemática.
...
El jugador no “progresa”.
El jugador **observa la evolución del sistema**.
...
CLICK domina el sistema
Trabajo Manual domina el sistema
Trueque domina el sistema
...
1) **Transparencia > progresión oculta**  
2) **Comprensión sistémica > optimización ciega**  
3) **El jugador interpreta — no grindea**
...
Este proyecto no está pensado como producto comercial,
sino como **experimento de diseño matemático y cognitivo**.

Si algo en el sistema te dispara una idea,
cuestionamiento o intuición nueva…
